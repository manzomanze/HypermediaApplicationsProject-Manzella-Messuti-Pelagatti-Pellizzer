...
export default {
  ...
  async asyncData({ $axios }) {
    const { data } = await $axios.get(`${process.env.BASE_URL}/api/areas/4`)
  ...
  //   head() {
  //     return {
  //       title: 'Response | Artificial Intelligence Services',
  //     }
  //   },
  //   created() {
